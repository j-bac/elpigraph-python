...
def computeElasticPrincipalCircle(X,
    ...
    return(computeElasticPrincipalGraphWithGrammars(X = X,
                                             NumNodes = NumNodes,
                                             NumEdges = NumEdges,
                                             InitNodes = InitNodes,
                                             Lambda = Lambda,
...
def generateInitialConfiguration(X, Nodes, Configuration = "Line",
    ...
    if(Configuration == "Random"):
        ...
        Dist = distutils.PartialDistance(X[[ID1],], X).flatten()
    ...
    if(Configuration == "Density"):
        ...
        if(len(tX) > MaxPoints):
            ...
            PartStruct = distutils.PartialDistance(tX[SampledIdxs, ], tX[SampledIdxs, ])
